...
I work across React, Next.js, TypeScript, accessibility, and product-facing frontend implementation.

I run Sola Studio, an independent frontend-focused practice providing frontend implementation, accessibility readiness, product clarity, and practical engineering support for product teams.

My work often sits where UI implementation, API collaboration, data flow, accessibility, product logic, and user experience meet. I care about making product screens easier to understand, implement, maintain, and improve across layers.
...
- UX-driven screen design and component structure
...
I also care about the friction that appears between layers: design intent, frontend behavior, API structure, data flow, business requirements, and user expectations.
